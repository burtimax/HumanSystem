...
namespace DiaryWinFormsNetFramework.UserControls
{
    public partial class TaskItem : UserControl, IDisposable
    {
        ...
        private void InitPanel()
        {
            ...
            {
                this._subPanel.Padding = new Padding(25,
        ...
        public void CreateAndAddSubTask()
        {
            ...
            subTask.OpenCloseArrow.Checked = false;
        }
        ...
        {
            GunaImageCheckBox box = sender as GunaImageCheckBox;
        ...
        public void DeleteTaskItem()
        {
            ...
            var parent = this.ParentTaskItem;
            ...
            //Если у родителя нет детей, то убрать у него стрелку
            if (parent?.SubTaskItems?.Count == 0)
            {
                parent.OpenCloseArrow.Checked = false;
            }
        }
